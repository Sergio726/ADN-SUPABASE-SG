-- =====================================================
-- Migración: Actualizar vista para incluir altura_final_cerco
-- Fecha: 2025-01-31
-- Descripción: Recrea la vista v_configuraciones_cercado_completas 
--              para asegurar que incluya el campo altura_final_cerco
-- =====================================================
...
SELECT 
  cc.*,  -- Esto incluye altura_final_cerco si la migración anterior se ejecutó
  -- Datos del tejido
...
COMMENT ON VIEW v_configuraciones_cercado_completas IS 'Vista con información completa y cálculos de costos de configuraciones de cercado, incluyendo altura_final_cerco';
