...
export default function NuevaConfiguracionCercadoPage() {
  ...
  useEffect(() => {
    // Debug: ver tejidos cargados
    console.log('Tejidos cargados:', tejidos.length)
    console.log('Altura seleccionada:', formData.altura)
    console.log('Tejidos filtrados:', tejidos.filter((t) => {
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  { label: 'Ganchos', cant: 'cantidad_ganchos', precio: 'precio_unitario_ganchos', default: '48' },
                  { label: 'Planchuelas', cant: 'cantidad_planchuelas', precio: 'precio_unitario_planchuelas', default: '12' },
                  { label: 'Torniquetes', cant: 'cantidad_torniquetes', precio: 'precio_unitario_torniquetes', default: '6' },
                  { label: 'Esparragos', cant: 'cantidad_esparragos', precio: 'precio_unitario_esparragos', default: '6' },
                ].map((item) => (
