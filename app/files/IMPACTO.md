# Registro de Impacto Positivo

Guarda aquí los hitos que demuestren cómo este proyecto genera valor.

## Cómo usar este registro
- **Fecha:** anota el día del hito o métrica.
- **Descripción:** resume qué sucedió y por qué es relevante.
- **Indicadores:** agrega datos concretos (ventas, leads, eficiencia, comentarios de clientes, etc.).
- **Responsable / Equipo:** quién lo impulsó o participó.
